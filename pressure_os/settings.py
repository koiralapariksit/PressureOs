"""
Django settings for pressure_os project.
...
TEMPLATES = [
    {
        ...
        'OPTIONS': {
            'context_processors': [
                ...
                'apps.execution.context_processors.execution_status',
            ],
        },
    },
]

WSGI_APPLICATION = 'pressure_os.wsgi.application'
